    ...
    >
      ...
      >
        ...
        <div className="relative aspect-video overflow-hidden bg-muted/20">
          ...
          {/* Quick live preview pill overlay on media hover */}
          {project.liveUrl && (
            <div className="absolute bottom-3 left-3 z-20 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-1 group-hover:translate-y-0">
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-lg border border-border/70 bg-background/90 backdrop-blur-md px-2.5 py-1 text-xs font-semibold text-foreground shadow-lg hover:border-primary/40 hover:text-primary transition-all duration-150"
              >
            ...
            <div className="flex items-center gap-2 relative z-20">
              {project.githubUrl && (
                <a
                  ...
                  title="Source Code"
                  className="flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-background text-muted-foreground hover:text-foreground hover:border-primary/30 hover:bg-primary/5 transition-all"
                >
